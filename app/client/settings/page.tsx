...
import { ChevronLeft, Save, Trash2, Eye, Bell, Moon } from 'lucide-react'
...
export default function ClientSettings() {
  ...
  useEffect(() => {
    ...
    if (clientData) {
      ...
      // Load toggles from local storage if they exist
  ...
  const toggleSetting = (key: keyof typeof settings) => {
    ...
    localStorage.setItem('user_feature_settings', JSON.stringify(newSettings))
  }
        ...
        <Card className="bg-slate-900/80 border-slate-700">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="border-t border-slate-700 pt-6">
              <p className="text-sm font-medium text-slate-300 mb-4">Feature Controls</p>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-slate-800/40 rounded-xl border border-slate-700">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500">Enable ability to delete chat history</p>
                    </div>
                  </div>
                  <Switch 
                    checked={settings.allowMessageDeletion} 
                    onCheckedChange={() => toggleSetting('allowMessageDeletion')}
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-slate-800/40 rounded-xl border border-slate-700">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">Presence Indicator</p>
                      <p className="text-[10px] text-slate-500">Show online status to others</p>
                    </div>
                  </div>
                  <Switch 
                    checked={settings.showPresence} 
                    onCheckedChange={() => toggleSetting('showPresence')}
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-slate-800/40 rounded-xl border border-slate-700">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500">Get system and chat alerts</p>
                    </div>
                  </div>
                  <Switch 
                ...
                <div className="flex items-center justify-between p-3 bg-slate-800/40 rounded-xl border border-slate-700">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500">Toggle dark/light interface</p>
                    </div>
                  </div>
                  <Switch 
