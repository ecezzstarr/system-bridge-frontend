...
export default function CampaignFlamePage() {
 ...
 const labels:Record<string,string>={interactions:'Interactions',crossings_opened:'Crossings opened',file_folder_movements:'File Folder movements',clients_confirmed:'Clients confirmed',provider_allocations:'Provider allocations',provider_value_trx:'Provider value (Flame Coin)'}
