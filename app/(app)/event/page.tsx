...
import FlameEventEntrance from '@/components/events/flame-event-entrance'
...
export default function EventPage() {
  ...
  return <><FlameEventEntrance/><main className="min-h-screen bg-black p-4 text-white md:p-8">
