...
const ROLE: Record<WorldRole, {
  ...
  client: {
    ...
    links: [
      ...
      { label: 'Enterprise Systems', detail: 'Million-scale technology', href: '/marketplace', icon: Store, tone: 'sky' },
  ...
  bridger: {
    ...
    links: [
      ...
      { label: 'Enterprise Systems', detail: 'Software + infrastructure', href: '/marketplace', icon: Store, tone: 'sky' },
  ...
  agent: {
    ...
    links: [
      ...
      { label: 'Enterprise Systems', detail: 'Large technology systems', href: '/marketplace', icon: Store, tone: 'sky' },
