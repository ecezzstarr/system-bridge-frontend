  ...
  return <section className="overflow-hidden rounded-3xl border border-white/10 bg-slate-950/90 text-white shadow-2xl">
    ...
    <div className="grid gap-0 lg:grid-cols-[1.2fr_.8fr]">
      <div className="p-5 md:p-7">
        <p className="text-[10px] uppercase tracking-[0.22em] text-sky-300">{position.mode === 'player' ? 'Client Player · Your Event' : 'Support Position · Client Movement'}</p>
      ...
      <aside className="border-t border-white/10 bg-black/20 p-5 lg:border-l lg:border-t-0 md:p-7">
        <p className="text-[10px] uppercase tracking-[0.22em] text-slate-500">{position.mode === 'player' ? 'Player movement' : 'Support movement'}</p>
