...
for(const route of ['/api/agility/payment/callback/route.ts','/api/agility/receive/route.ts','/api/agility/sales/route.ts','/api/admin/agility/stock/route.ts'])assert.ok(fs.existsSync(path.join(root,'app',route)),route+' exists')
