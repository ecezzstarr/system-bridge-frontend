...
const exact: Record<string, WeaveEnvironmentCopy> = {
  ...
  '/bridger/dashboard': {
    key: 'bridger-home-world',
    title: 'Bridger Home World',
    district: 'Bridge',
    purpose: 'The Bridger arrival ground for Prospect movement, Client continuity, partnership standing and company support.',
    movement: 'Arrive → connect → support → continue',
    layer: 'world',
  },
  '/agent/dashboard': {
    key: 'agent-home-world',
    title: 'Agent Home World',
    district: 'Support',
    purpose: 'The Agent arrival ground connecting Bridger support, company work, delivery, Client service and livelihood.',
    movement: 'Arrive → receive function → support → confirm',
    layer: 'world',
  },
  '/dashboard': {
    key: 'position-router',
    ...
    district: 'Presence',
    purpose: 'Resolve the authenticated participant into the correct WEAVE role world.',
    movement: 'Recognize position → enter role world',
    layer: 'interaction',
  },
  '/receipts': {
    key: 'receipt-registry',
    title: 'Receipt Registry',
    district: 'Presence',
    purpose: 'The canonical record of issued payment, purchase, withdrawal and participation receipts.',
    movement: 'Movement → receipt → preserved record',
    layer: 'system',
  },
  '/client-interactions': {
    key: 'client-service-field',
    title: 'Client Service Field',
    district: 'Support',
    purpose: 'Authorized support interaction around Client movement without changing Client ownership.',
    movement: 'Receive Client movement → support → confirm continuity',
    layer: 'interaction',
  },
  '/clients': {
    key: 'client-presence-registry',
    title: 'Client Presence Registry',
    district: 'Support',
    purpose: 'A company-side view of Client relationship state and continuity, not a separate Client world.',
    movement: 'Recognize Client → enter support path → continue relationship',
    layer: 'district',
  },
  '/roles': {
    key: 'position-identity',
    title: 'Position + Identity',
    district: 'Presence',
    purpose: 'The environment for personal identity settings and the institutional position currently operating.',
    movement: 'Inspect identity → adjust allowed fields → preserve position',
    layer: 'system',
  },
  '/places': {
    ...
    district: 'Enterprise',
    purpose: 'A routing district connecting canonical enterprise, participation and intelligence environments without duplicating them.',
    movement: 'Choose consequence → enter system → return with changed state',
    layer: 'district',
  },
  '/private-ground': {
    key: 'private-ground',
    ...
    district: 'Bridge',
    purpose: 'A bounded interaction environment where private movement remains attached to recorded session state.',
    movement: 'Enter → interact → record → continue',
    layer: 'interaction',
  },
  '/authority': {
    key: 'authority-space',
    title: 'Ecosystem Authority',
    district: 'Institution',
    purpose: 'Administration-only entry into governance, intelligence and institutional system workshops.',
    movement: 'Inspect authority → enter workshop → govern → verify',
    layer: 'district',
  },
  '/authority/workshops': {
    key: 'authority-workshops',
    title: 'Authority Workshops',
    district: 'Institution',
    purpose: 'The institutional workshop environment for protocols, intelligence, system authority and governed change.',
    movement: 'Define → authorize → implement → verify',
    layer: 'system',
  },
  '/weave/market/prospects': {
    key: 'prospect-market',
    title: 'Prospect Market',
    district: 'Bridge',
    purpose: 'The Bridger acquisition environment for authorized Prospect movement before Client crossing.',
    movement: 'Acquire Prospect → make contact → bridge → continue',
    layer: 'system',
  },
  '/wallet/deposit-withdraw': {
    ...
    district: 'Presence',
    purpose: 'The canonical lifecycle for funding, withdrawal and recorded operational value movement.',
    movement: 'Prepare → move → verify → record',
    layer: 'system',
  },
  '/fund-wall': {
    key: 'reserve-engine',
    ...
    district: 'Presence',
    purpose: 'The governed reserve environment for authorized platform value.',
    movement: 'Inspect reserve → authorize movement → record',
    layer: 'system',
  },
  '/client/arena': {
    key: 'client-arena-ground',
    title: 'Client Arena Ground',
    district: 'WEAVE',
    purpose: 'Shared participant contest movement entered from the Client position without changing Client ownership.',
    movement: 'Enter → participate → resolve → return',
    layer: 'district',
  },
  '/client/casino': {
    key: 'client-pattern-ground',
    title: 'Client Pattern Ground',
    district: 'WEAVE',
    purpose: 'Shared user-versus-system pattern movement entered from the Client position.',
    movement: 'Enter → interact → resolve → return',
    layer: 'district',
  },
  '/weave/standing': {
    key: 'standing-field',
...
const prefix: Array<[string, WeaveEnvironmentCopy]> = [
  ['/weave/file-folder', {
    key: 'support-file-folder',
    title: 'Client File Folder · Support View',
    district: 'Bridge',
    purpose: 'Authorized support entry into an existing Client-owned File Folder. Support can assist but cannot own or operate the Client position.',
    movement: 'Select Client → enter support view → assist → preserve ownership',
    layer: 'world',
  }],
  ['/agent-chat', {
    key: 'agent-client-support',
    title: 'Agent Client Support Room',
    district: 'Support',
    purpose: 'Authorized Agent interaction attached to a specific Client support movement.',
    movement: 'Receive → clarify → support → record',
    layer: 'interaction',
  }],
  ['/bridge/', {
    key: 'bridge-radiance-crossing',
    title: 'Bridge Radiance Crossing',
    district: 'Bridge',
    purpose: 'The Prospect-facing crossing environment opened by an authorized Bridger link.',
    movement: 'Arrive → interact → recognize → cross',
    layer: 'interaction',
  }],
  ['/store/', {
    key: 'customer-door',
    title: 'Customer Door',
    district: 'Enterprise',
    purpose: 'The public commercial doorway of a Client system that has reached an authorized live state.',
    movement: 'Discover → choose → order → create Client value',
    layer: 'interaction',
  }],
  ['/river/', {
    key: 'river-interaction',
    title: 'River Interaction',
    district: 'Bridge',
    purpose: 'A guided interaction channel that carries external movement toward the appropriate WEAVE path.',
    movement: 'Speak → recognize need → route → continue',
    layer: 'interaction',
  }],
