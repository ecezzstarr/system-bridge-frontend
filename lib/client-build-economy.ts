...
export const CLIENT_PUBLIC_DOOR_THRESHOLD_FLAME_COIN =
  WORLD_RULES.FILE_FOLDER_PUBLIC_DOOR_THRESHOLD_FLAME_COIN

export const CLIENT_BUILD_SPEED_MIN = WORLD_RULES.CLIENT_BUILD_SPEED_MIN
export const CLIENT_BUILD_SPEED_MAX = WORLD_RULES.CLIENT_BUILD_SPEED_MAX
