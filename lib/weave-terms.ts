...
export const FILE_FOLDER_CONTENT = {
  ...
  establishment: 'When a Prospect purchases either a Standard or Premium File Folder and the payment is verified, their place in System Switch is established. Standard begins at 180 Flame Coin and can be any value below the 35,800 Flame Coin Premium price. The Folder then becomes the environment through which their enterprise, decisions, actions, needs, support, learning, builds, public Customer Door and progress continue to move. A Customer Door begins formation in the Client’s first participation days so outside customers can patronize the Client while the Client continues building inside WEAVE. Your File Folder is not a document. It is your working environment inside Weave.',
}
